...
void CProofMode::SetMenuBackgroundPositionNames()
{
	...
	m_vpMenuBackgroundPositionNames[CMenuBackground::POS_SETTINGS_LION] = "settings(lion)";
	m_vpMenuBackgroundPositionNames[CMenuBackground::POS_SETTINGS_PROFILE] = "settings(profile)";
