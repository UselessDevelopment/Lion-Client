...
std::array<vec2, CMenuBackground::NUM_POS> GenerateMenuBackgroundPositions()
{
	...
	Positions[CMenuBackground::POS_SETTINGS_ASSETS] = vec2(200.0f, 200.0f);
	Positions[CMenuBackground::POS_SETTINGS_LION] = vec2(500.0f, 200.0f);
	Positions[CMenuBackground::POS_SETTINGS_PROFILE] = vec2(500.0f, 500.0f);
