...
void CMenus::RenderSettings(CUIRect MainView)
{
	...
	else if(g_Config.m_UiSettingsPage == SETTINGS_LION)
	{
		m_pBackground->ChangePosition(CMenuBackground::POS_SETTINGS_LION);
		RenderSettingsLion(MainView);
	}
	else if(g_Config.m_UiSettingsPage == SETTINGS_PROFILES)
	{
		m_pBackground->ChangePosition(CMenuBackground::POS_SETTINGS_PROFILE);
...
enum
{
	LION_TAB_PAGE1 = 0,
	LION_TAB_PAGE2 = 1,
	LION_TAB_BINDWHEEL = 2,
	NUMBER_OF_LION_TABS = 3,
};

void CMenus::RenderSettingsLion(CUIRect MainView)
{
	...
	LabelTop.VSplitLeft(TabsW / NUMBER_OF_LION_TABS, &Page1Tab, &Page2Tab);
	Page2Tab.VSplitLeft(TabsW / NUMBER_OF_LION_TABS, &Page2Tab, &Page3Tab);

	static CButtonContainer s_aPageTabs[NUMBER_OF_LION_TABS] = {};
	if(DoButton_MenuTab(&s_aPageTabs[LION_TAB_PAGE1], Localize("Page 1"), s_CurCustomTab == LION_TAB_PAGE1, &Page1Tab, 5, NULL, NULL, NULL, NULL, 4))
		s_CurCustomTab = LION_TAB_PAGE1;
	if(DoButton_MenuTab(&s_aPageTabs[LION_TAB_PAGE2], Localize("Page 2"), s_CurCustomTab == LION_TAB_PAGE2, &Page2Tab, 0, NULL, NULL, NULL, NULL, 4))
		s_CurCustomTab = LION_TAB_PAGE2;
	if(DoButton_MenuTab(&s_aPageTabs[LION_TAB_BINDWHEEL], Localize("BindWheel"), s_CurCustomTab == LION_TAB_BINDWHEEL, &Page3Tab, 10, NULL, NULL, NULL, NULL, 4))
		s_CurCustomTab = LION_TAB_BINDWHEEL;

	const float LineMargin = 20.0f;

	// MainView.HSplitTop(10.0f, 0x0, &MainView);
	if(s_CurCustomTab == LION_TAB_PAGE1)
	{
	...
	if(s_CurCustomTab == LION_TAB_PAGE2)
	{
		MainView.VSplitLeft(MainView.w * 0.5, &MainView, &Column);
	...
	if(s_CurCustomTab == LION_TAB_BINDWHEEL)
	{
