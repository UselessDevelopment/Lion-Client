...
void CLion::ConRandomTee(IConsole::IResult *pResult, void *pUserData) {}

void CLion::ConchainRandomColor(IConsole::IResult *pResult, void *pUserData, IConsole::FCommandCallback pfnCallback, void *pCallbackUserData)
{
	CLion *pThis = static_cast<CLion *>(pUserData);
...
void CLion::RandomFlag(void *pUserData)
{
	CLion *pThis = static_cast<CLion *>(pUserData);
	// get the flag count
